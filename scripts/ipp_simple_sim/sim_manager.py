...
class SimManager:
    ...
    def __init__(self, robot_names: List[str]) -> None:
        ...
        self.max_zvel = rospy.get_param("~max_zvel")

        self.agent_l = rospy.get_param("~agent_l")

        self.hvel = rospy.get_param("~hvel")
        self.vvel = rospy.get_param("~vvel")

        self.n_rand_targets = rospy.get_param("~n_rand_targets")

        self.del_t = rospy.get_param("~del_t")

        self.K_p = rospy.get_param("~K_p")
        self.K_p_z = rospy.get_param("~K_p_z")
    ...
    def plan_request_callback(self, plan_request: PlanRequest, id_num: int) -> None:
        ...
        set_true_targets_to_target_prior_means = rospy.get_param("~set_true_targets_to_target_prior_means")
        sample_true_targets_from_target_priors = rospy.get_param("~sample_true_targets_from_target_priors")
        sample_additional_true_targets_from_search_prior = rospy.get_param("~sample_additional_true_targets_from_search_prior")
        ...
        heading = rospy.get_param("~rand_heading_range")
        linear_speed = rospy.get_param("~rand_linear_speed_range")
        angular_speed = rospy.get_param("~rand_angular_speed_range")
